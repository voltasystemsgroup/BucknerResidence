...
namespace UserModule_DENON_AVR_3313CI_IP_V1_1_PROCESSOR
{
    public class UserModuleClass_DENON_AVR_3313CI_IP_V1_1_PROCESSOR : SplusObject
    {
    ...
    private void PROCESSDEVICERXMSG (  SplusExecutionContext __context__ ) 
        { 
                                                                        ...
                                                                        if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Find( "CVFWR" , SRESPONSE ) == 1))  ) ) 
                                                                            ...
                                                                            if ( Functions.TestForTrue  ( ( Functions.BoolToInt (Functions.Find( "NSE" , SRESPONSE ) == 1))  ) ) 
                                                                                ...
                                                                                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt (ISTRINGNUMBER == 0) ) || Functions.TestForTrue ( Functions.BoolToInt (ISTRINGNUMBER == 8) )) ))  ) ) 
                                                                                    ...
                                                                                    SDUMP  .UpdateValue ( Functions.Left ( SDUMP ,  (int) ( (Functions.Find( "\u0000" , SDUMP ) - 1) ) )  ) ; 
        ...
        try
        {
            ...
            while ( Functions.TestForTrue  ( ( 1)  ) ) 
                ...
                try 
                    ...
                    PROCESSDEVICERXMSG (  __context__  ) ; 
                    } 
    ...
    public UserModuleClass_DENON_AVR_3313CI_IP_V1_1_PROCESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
    ...
    const uint SURROUND_LEFT_LEVEL_TEXT__AnalogSerialOutput__ = 10;
    const uint SURROUND_RIGHT_LEVEL_TEXT__AnalogSerialOutput__ = 11;
    const uint SURROUND_BACK_LEFT_LEVEL_TEXT__AnalogSerialOutput__ = 12;
    const uint SURROUND_BACK_RIGHT_LEVEL_TEXT__AnalogSerialOutput__ = 13;
    const uint SURROUND_BACK_LEVEL_TEXT__AnalogSerialOutput__ = 14;
    const uint FRONT_HEIGHT_LEFT_LEVEL_TEXT__AnalogSerialOutput__ = 15;
    const uint FRONT_HEIGHT_RIGHT_LEVEL_TEXT__AnalogSerialOutput__ = 16;
    const uint FRONT_WIDE_LEFT_LEVEL_TEXT__AnalogSerialOutput__ = 17;
    const uint FRONT_WIDE_RIGHT_LEVEL_TEXT__AnalogSerialOutput__ = 18;
    const uint TUNER_FREQUENCY__AnalogSerialOutput__ = 19;
    const uint TO_DEVICE__AnalogSerialOutput__ = 20;
    const uint LINE_OUT__AnalogSerialOutput__ = 21;
